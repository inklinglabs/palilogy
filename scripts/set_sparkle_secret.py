...
secret SPARKLE_PRIVATE_KEY for inklinglabs/palilogy and checks that the
public key in Palilogy/Info.plist matches the one in 1Password.
...
for the inklinglabs/palilogy repo.
"""
