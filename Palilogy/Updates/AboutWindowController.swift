...
/// About window (ported from Handybar). The standard About panel cannot hold
/// a button, and this one needs Check for Updates, so it is built by hand.
@MainActor
final class AboutWindowController: NSWindowController {

    static let shared = AboutWindowController()
    static let repoURL = URL(string: "https://github.com/inklinglabs/palilogy")!
    ...
    private func buildUI() {
        ...
        let name = NSTextField(labelWithString: "Palilogy")
        ...
        let repo = linkButton("github.com/inklinglabs/palilogy", #selector(openRepo))
